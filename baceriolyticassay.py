...
plt.legend(["A1 ("+str(simps(A1,x=timestamps).round(2))+")", "A2 ("+str(simps(A2,x=timestamps).round(2))+")"
               ,"A3 ("+str(simps(A3,x=timestamps).round(2))+")", "A4 ("+str(simps(A4,x=timestamps).round(2))+")"],prop={'size': 8})
plt.xlabel("Tijd"), plt.ylabel("OD")
...
plt.legend(["B1 ("+str(simps(B1,x=timestamps).round(2))+")", "B2 ("+str(simps(B2,x=timestamps).round(2))+")"
               ,"B3 ("+str(simps(B3,x=timestamps).round(2))+")", "B4 ("+str(simps(B4,x=timestamps).round(2))+")"],prop={'size': 8})
plt.xlabel("Tijd"), plt.ylabel("OD")
...
plt.legend(["C1 ("+str(simps(C1,x=timestamps).round(2))+")", "C2 ("+str(simps(C2,x=timestamps).round(2))+")"
               ,"C3 ("+str(simps(C3,x=timestamps).round(2))+")", "C4 ("+str(simps(C4,x=timestamps).round(2))+")"],prop={'size': 8})
plt.xlabel("Tijd"), plt.ylabel("OD")
...
plt.legend(["D1 ("+str(simps(D1,x=timestamps).round(2))+")", "D2 ("+str(simps(D2,x=timestamps).round(2))+")"
               ,"D3 ("+str(simps(D3,x=timestamps).round(2))+")", "D4 ("+str(simps(D4,x=timestamps).round(2))+")"],prop={'size': 8})
plt.xlabel("Tijd"), plt.ylabel("OD")
...
plt.legend(["E1 ("+str(simps(E1,x=timestamps).round(2))+")", "E2 ("+str(simps(E2,x=timestamps).round(2))+")"
               ,"E3 ("+str(simps(E3,x=timestamps).round(2))+")", "E4 ("+str(simps(E4,x=timestamps).round(2))+")"],prop={'size': 8})
plt.xlabel("Tijd"), plt.ylabel("OD")
...
plt.legend(["F1 ("+str(simps(F1,x=timestamps).round(2))+")", "F2 ("+str(simps(F2,x=timestamps).round(2))+")"
               ,"F3 ("+str(simps(F3,x=timestamps).round(2))+")", "F4 ("+str(simps(F4,x=timestamps).round(2))+")"],prop={'size': 8})
plt.xlabel("Tijd"), plt.ylabel("OD")

plt.subplot(3, 3, 7)
plt.plot(timestamps, G1), plt.plot(timestamps, G2), plt.plot(timestamps, G3), plt.plot(timestamps, G4)
plt.legend(["G1 ("+str(simps(G1,x=timestamps).round(2))+")", "G2 ("+str(simps(G2,x=timestamps).round(2))+")"
               ,"G3 ("+str(simps(G3,x=timestamps).round(2))+")", "G4 ("+str(simps(G4,x=timestamps).round(2))+")"],prop={'size': 8})
plt.xlabel("Tijd"), plt.ylabel("OD")

plt.subplot(3, 3, 8)
plt.plot(timestamps, H1), plt.plot(timestamps, H2), plt.plot(timestamps, H3), plt.plot(timestamps, H4)
plt.legend(["H1 ("+str(simps(H1,x=timestamps).round(2))+")", "H2 ("+str(simps(H2,x=timestamps).round(2))+")"
               ,"H3 ("+str(simps(H3,x=timestamps).round(2))+")", "H4 ("+str(simps(H4,x=timestamps).round(2))+")"],prop={'size': 8})
plt.xlabel("Tijd"), plt.ylabel("OD")
